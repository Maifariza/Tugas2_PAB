    ...
    if (!_agreeTerms) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          ...
          backgroundColor: Color.fromARGB(255, 231, 58, 58),
        ),
      );
      return;
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: Color.fromARGB(255, 255, 118, 163),
        elevation: 2,
        centerTitle: true,
        actions: [
            ...
            children: [
              ...
              ElevatedButton.icon(
                ...
                style: ElevatedButton.styleFrom(
                  backgroundColor: const Color.fromARGB(255, 255, 172, 204),
